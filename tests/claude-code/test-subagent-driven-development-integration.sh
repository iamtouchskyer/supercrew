...
mkdir -p src test docs/plans/test-math

# Create a simple implementation plan
cat > docs/plans/test-math/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/plans/test-math/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/plans/test-math/implementation-plan.md using the subagent-driven-development skill.
