...
# Create a plan
cat > "$PROJECT_DIR/docs/plans/auth-system/implementation-plan.md" << 'EOF'
...
claude -p "I have a plan at docs/plans/auth-system/implementation-plan.md. Tell me about my options for executing it, including what subagent-driven-development means and how it works." \
    --model haiku \
